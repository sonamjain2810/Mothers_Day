            ...
            child: Column(
              children: <Widget>[
                ...
                Column(
                  children: <Widget>[
                    ListTile(
                      leading: const Icon(MdiIcons.youtube, color: Colors.red),
                      title: Text(
                        "Search on YouTube",
                    ...
                    ListTile(
                      leading:
                          const Icon(MdiIcons.instagram, color: Colors.indigo),
                      title: Text(
                    ...
                    ListTile(
                      leading:
                          const Icon(MdiIcons.facebook, color: Colors.blue),
                      title: Text(
                        "Like Me on Facebook",
                        style: Theme.of(context).textTheme.bodyMedium,
                      ),
                    ...
                    ListTile(
                        leading:
                            const Icon(MdiIcons.twitter, color: Colors.cyan),
                        title: Text(
